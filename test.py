...
from models import LCF_BERT, LCF_BERT_ONLY_LOCAL, LCF_BERT_ONLY_GLO, LCF_BERT_LOCAL_CLS
from models import LCF_BERT_xGlo_1_xLocal, LCF_BERT_ONLY_Global_1
...
class Instructor:
    ...
    def run(self):
        ...
        best_model_path = "/home/jye/ABSA/Curriculum Learning/state_dict/train/bert_spc/laptop/cdm/42/epoch7_step40_acc_0.8225_f10.8032"
        self.model.load_state_dict(torch.load(best_model_path, map_location='cuda:9'))
...
def main():
    ...
    parser.add_argument('--dataset', default='laptop_explicit', type=str)
    ...
    parser.add_argument('--batch_size', default=1120, type=int, help='try 16, 32, 64 for BERT models')
    ...
    dataset_files = {
        ...
        'restaurant_total': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/restaurant/txt1/test_total_text.txt"
        },
        'restaurant_implicit': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/restaurant/txt1/test_implicit_text.txt"
        },
        'restaurant_explicit': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/restaurant/txt1/test_explicit_text.txt"
        },
        'laptop_total': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/laptop/txt1/test_total_text.txt"
        },
        'laptop_implicit': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/laptop/txt1/test_implicit_text.txt"
        },
        'laptop_explicit': {
            'test': "/home/jye/ABSA/Curriculum Learning/datasets/implicit/laptop/txt1/test_explicit_text.txt"
        },
        'MAMS': {
    ...
    log_file = 'test:{}-{}-{}-{}-{}.log'.format(
        opt.model_name, opt.dataset, opt.local_context_focus, opt.seed, strftime("%y%m%d-%H%M", localtime()))
